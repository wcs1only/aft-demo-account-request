...
module "charlie-aft-test-beta-02" {
  source = "./modules/aft-account-request"

  control_tower_parameters = {
    AccountEmail = "charlie-aft-test-beta-02@willardstanley.com"
    AccountName  = "charlie-aft-test-beta-02"
    # Syntax for top-level OU
    # Syntax for nested OU
    ManagedOrganizationalUnit = "Beta (ou-8p8k-vb6r5f1b)"
    SSOUserEmail     = "charlie-aft-test-beta-02@willardstanley.com"
    SSOUserFirstName = "Beta"
    SSOUserLastName  = "One"
  }
