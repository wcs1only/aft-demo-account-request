...
module "charlie-aft-test-prod-02" {
  source = "./modules/aft-account-request"

  control_tower_parameters = {
    AccountEmail = "charlie-aft-test-prod-02@willardstanley.com"
    AccountName  = "charlie-aft-test-prod-02"
    # Syntax for top-level OU
    # Syntax for nested OU
    ManagedOrganizationalUnit = "Prod (ou-8p8k-d5qvozef)"
    SSOUserEmail     = "charlie-aft-test-prod-02@willardstanley.com"
    SSOUserFirstName = "Prod"
    SSOUserLastName  = "One"
  }
